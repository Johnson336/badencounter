...
RAYLIB_INCLUDE_PATH   ?= ./raylib/raylib-5.0/src
RAYLIB_LIB_PATH       ?= ./raylib/raylib-5.0/src
...
#------------------------------------------------------------------------------------------------
INCLUDE_PATHS = -I. -I$(PROJECT_BUILD_PATH)/include
...
#------------------------------------------------------------------------------------------------
LDFLAGS = -L. -L$(PROJECT_BUILD_PATH)/lib -L$(RAYLIB_LIB_PATH)
...
ifeq ($(PLATFORM),PLATFORM_DESKTOP)
    ...
    ifeq ($(PLATFORM_OS),OSX)
        ...
        # LDLIBS = -lraylib -framework OpenGL -framework Cocoa -framework IOKit -framework CoreAudio -framework CoreVideo 
		    # LDLIBS = -framework IOKit -framework Cocoa -framework OpenGL `pkg-config --cflags --libs raylib`
				LDLIBS = -framework IOKit -framework Cocoa -framework OpenGL -lraylib -lSDL2
    endif
    ifeq ($(PLATFORM_OS),BSD)
...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    #LDLIBS = $(RAYLIB_RELEASE_PATH)/libraylib.a
		LDLIBS = `pkg-config --cflags --libs raylib`
endif
